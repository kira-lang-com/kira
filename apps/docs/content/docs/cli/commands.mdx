...
description: Command-by-command behavior for the current `kira-bootstrapper` CLI.
---

## `run`

```bash
kira-bootstrapper run [--backend vm|llvm|hybrid] <file.kira>
```
...
```bash
kira-bootstrapper build [--backend vm|llvm|hybrid] <file.kira>
```
...
```bash
kira-bootstrapper check <file.kira>
```
...
```bash
kira-bootstrapper tokens <file.kira>
```
...
```bash
kira-bootstrapper ast <file.kira>
```
...
```bash
kira-bootstrapper new <Name> <destination>
```
