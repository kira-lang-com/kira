...
impl<'ctx> NativeCodegen<'ctx> {
    pub(in crate::aot::native) fn declare_runtime_box_int(&self) -> FunctionValue<'ctx> {
    ...
    pub(in crate::aot::native) fn declare_runtime_box_bool(&self) -> FunctionValue<'ctx> {
        let handle = self.context.i8_type().ptr_type(AddressSpace::default());
        self.declare_runtime_function(
    ...
    pub(in crate::aot::native) fn declare_runtime_box_float(&self) -> FunctionValue<'ctx> {
        let handle = self.context.i8_type().ptr_type(AddressSpace::default());
        self.declare_runtime_function(
    ...
    pub(in crate::aot::native) fn declare_runtime_unbox_int(&self) -> FunctionValue<'ctx> {
        self.declare_runtime_function(
    ...
    pub(in crate::aot::native) fn declare_runtime_unbox_bool(&self) -> FunctionValue<'ctx> {
        self.declare_runtime_function(
    ...
    pub(in crate::aot::native) fn declare_runtime_unbox_float(&self) -> FunctionValue<'ctx> {
        self.declare_runtime_function(
    ...
    pub(in crate::aot::native) fn declare_runtime_clone_value(&self) -> FunctionValue<'ctx> {
        let handle = self.context.i8_type().ptr_type(AddressSpace::default());
        self.declare_runtime_function(
    ...
    pub(in crate::aot::native) fn declare_runtime_make_string(&self) -> FunctionValue<'ctx> {
    ...
    pub(in crate::aot::native) fn declare_runtime_value_eq(&self) -> FunctionValue<'ctx> {
        self.declare_runtime_function(
    ...
    pub(in crate::aot::native) fn call_runtime_value_eq(
        &mut self,
